    ...
    <section className="bg-[#bcd1e5] py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-8xl mx-auto text-center">
        ...
        <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
          ...
          Join our newsletter and be the first to know about everything happening at our Odomite Rentals
        </p>
        ...
        <div className="max-w-md mx-auto">
          <form className="flex flex-col sm:flex-row gap-3">
            ...
            <Button type="submit" className="h-12 px-8 text-base font-medium whitespace-nowrap">
              Subscribe Now
            </Button>
          </form>
