...
import { products, local_products } from '../deviceinfo';
...
const Body = (props) => {
  ...
  return (
    <div className='hero'>
      ...
      />
      <ProductCard cart="Tent" products={items} />
      <Header
        heading="Children's Rental"
        paragraph="10 X 10, 20 X 10 and more"
      />
      <ProductCard cart="Kids" products={items} />
      <HeaderBanner />
